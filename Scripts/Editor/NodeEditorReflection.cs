...
namespace XMonoNodeEditor {
    ...
    public static class NodeEditorReflection {
        ...
        public static Type[] GetNodeTypes() {
            ...
            return GetDerivedTypes(typeof(XMonoNode.INode));
        }
        ...
        public static bool TryGetAttributeTint(this Type nodeType, out Color tint) {
            if (nodeTint == null) {
                CacheAttributes<Color, XMonoNode.NodeTintAttribute>(ref nodeTint, x => x.color);
            }
        ...
        public static bool TryGetAttributeWidth(this Type nodeType, out int width) {
            if (nodeWidth == null) {
                CacheAttributes<int, XMonoNode.NodeWidthAttribute>(ref nodeWidth, x => x.width);
            }
        ...
        public static FieldInfo GetFieldInfo(this Type type, string fieldName) {
            ...
            while (field == null && (type = type.BaseType) != typeof(XMonoNode.INode)) field = type.GetField(fieldName, BindingFlags.NonPublic | BindingFlags.Instance);
            return field;
        }
